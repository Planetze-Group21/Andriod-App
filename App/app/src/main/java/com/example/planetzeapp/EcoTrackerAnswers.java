...
public class EcoTrackerAnswers extends AppCompatActivity {
    ...
    private void openDialog1(String category, String activity, TextView resultText) {
        String todayDate = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date());
        Dialog dialog = new Dialog(EcoTrackerAnswers.this);
                ...
                try {
                    ...
                    ref.child("value").setValue(value).addOnSuccessListener(aVoid -> {
                        ...
                        ref.child("emissions").setValue(emissions).addOnSuccessListener(aVoid1 -> {
                            Toast.makeText(EcoTrackerAnswers.this, "Data saved successfully for " + activity, Toast.LENGTH_SHORT).show();
                            resultText.setText(String.valueOf(emissions));
                            dialog.dismiss();
                        }).addOnFailureListener(e -> {
                            Toast.makeText(EcoTrackerAnswers.this, "Failed to save emissions for " + activity + ": " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
                    }).addOnFailureListener(e -> {
                        Toast.makeText(EcoTrackerAnswers.this, "Failed to save value for " + activity + ": " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
                } catch (NumberFormatException e) {
                    Toast.makeText(EcoTrackerAnswers.this, "Please enter a valid number", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(EcoTrackerAnswers.this, "Text cannot be empty", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void openDialog2(String category, String activity, TextView resultText) {
        ...
        saveButton.setOnClickListener(view -> {
            ...
            if (selectedOptionId == -1) {
                Toast.makeText(EcoTrackerAnswers.this, "Please select an option", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (!userInput.isEmpty()) {
                try {
                    ...
                    ref.child("value").setValue(value).addOnSuccessListener(aVoid -> {
                        ...
                        double finalEmissions = emissions;
                        ref.child("emissions").setValue(emissions).addOnSuccessListener(aVoid1 -> {
                            Toast.makeText(EcoTrackerAnswers.this, "Data saved successfully for " + selectedOption, Toast.LENGTH_SHORT).show();
                            resultText.setText(String.valueOf(finalEmissions));
                            dialog.dismiss();
                        }).addOnFailureListener(e -> {
                            Toast.makeText(EcoTrackerAnswers.this, "Failed to save emissions for " + selectedOption + ": " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
                    }).addOnFailureListener(e -> {
                        Toast.makeText(EcoTrackerAnswers.this, "Failed to save value for " + selectedOption + ": " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
                } catch (NumberFormatException e) {
                    Toast.makeText(EcoTrackerAnswers.this, "Please enter a valid number", Toast.LENGTH_SHORT).show();
                }
